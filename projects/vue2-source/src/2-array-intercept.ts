type TMutationMethodNames = 'push' | 'pop' | 'shift' | 'unshift' | 'splice' | 'sort' | 'reverse'
...
const methods: Array<TMutationMethodNames> = ['push', 'pop', 'shift', 'unshift', 'splice', 'sort', 'reverse']
