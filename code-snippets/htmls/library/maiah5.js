  ...
  return (function (a) {
    ...
    function (a, e, t) {
      ...
      var f = t(8),
        p = f.prefixUrls,
        m = f.schemeUrl
      ;(window.appflag = !1), (window.deviceflag = !1), (window.data = null)
      ...
      a.exports = {
        joinParamToUrl: function (a) {
          ...
          if (A(a)) {
            for (var o in a) {
              ...
              e.indexOf(o) > -1 ||
                (N(n) || E(n)
                  ? (t += o + '=' + encodeURIComponent((0, l.default)(n)) + '&')
        ...
        isRequired: function (a, e) {
          return '' === a || null === a || void 0 === a
            ? (console.error('参数' + e + '是必填参数，但是当前是' + a), 0)
            : 1
        },
        ...
        paserObj: function (a) {
          var e = a
          if (
            'object' !== (void 0 === a ? 'undefined' : (0, _.default)(a)) &&
            a
          )
            try {
              e = JSON.parse(a)
      ...
      var o = t(3),
        ...
        l = function (a, e, t) {
          var s,
            ...
            v = f ? n : n[e] || (n[e] = {}),
            w = v.prototype,
            g = f ? o : p ? o[e] : (o[e] || {}).prototype
          for (s in (f && (t = e), t))
            ((u = !d && g && void 0 !== g[s]) && c(v, s)) ||
              ((_ = u ? g[s] : t[s]),
              (v[s] =
                f && 'function' != typeof g[s]
                  ? t[s]
                  : b && u
                  ? i(_, o)
                  : h && g[s] == _
    ...
    function (a, e, t) {
      ...
      ;(e.prefixUrls = {
        ...
        (e.callbackNames = {
          ...
          REDIRECT_LOGIN_CONFIRM: '__maia_redirect_login_confirm_callback__',
          ...
          (T[a] = function () {
            ...
            if (this.IFRAME_ENV)
                  ...
                  i.forEach(function (t, n) {
                    if (E(t)) {
                      for (var i in t)
                        if (A(t[i])) {
                          var c =
                            '__maia_custom_' + e + '_' + i + '_callback' + o
              ...
              ;(I[a].MAIA_IFRAME_ID = T[a].MAIA_IFRAME_ID || ''),
                (I[a].MAIA_SUPPORT_IFRAMES = T[a].MAIA_SUPPORT_IFRAMES || !1),
    ...
    function (a, e, t) {
      ...
      t(53)(
        ...
        function () {
          ...
          return t >= e.length
            ? { value: void 0, done: !0 }
            : ((a = o(e, t)), (this._i += a.length), { value: a, done: !1 })
        }
      )
    },
    function (a, e) {
    ...
    function (a, e, t) {
      ...
      a.exports = function (a, e) {
        if (!o(a)) return a
        var t, n
        if (e && 'function' == typeof (t = a.toString) && !o((n = t.call(a))))
          return n
    ...
    function (a, e, t) {
      ...
      a.exports = function (a, e, t, p, m, b, h) {
        ...
        var v,
          ...
          C = y || k(m),
          T = m ? (A ? k('entries') : C) : void 0,
          O = ('Array' == e && I.entries) || y
        if (
          (O &&
            (g = u(O.call(new a()))) !== Object.prototype &&
            g.next &&
            (s(g, E, !0), o || 'function' == typeof g[_] || r(g, _, f)),
          A &&
            y &&
            'values' !== y.name &&
            ((N = !0),
    ...
    function (a, e, t) {
      ...
      a.exports = function (a, e) {
        ...
        for (; e.length > l; ) o(c, (t = e[l++])) && (~i(s, t) || s.push(t))
        return s
      }
    },
    function (a, e, t) {
    ...
    function (a, e, t) {
      ...
      function g(a) {
        ...
        'string' == typeof a
          ...
          : h(a)
          ? ((g.iframeElList = g.iframeElList ? g.iframeElList : []),
            (g.MAIA_SUPPORT_IFRAMES = !0),
            a.forEach(function (a) {
              var e = {},
                t = document.querySelector(a)
              ;(e.el = t), (e.id = a), (e[a] = t), g.iframeElList.push(e)
            }),
            (t = g.iframeElList))
          : v(a) &&
        ...
        if (null !== a.data)
          try {
            ...
            'object' !== (void 0 === e ? 'undefined' : (0, o.default)(e)) &&
              e &&
              (e = JSON.parse(e)),
              g.iframeCallbackList[a.data.actionName] &&
                g.iframeCallbackList[a.data.actionName](e),
              window.iframeCallbackList[a.data.actionName] &&
                window.iframeCallbackList[a.data.actionName](e)
          } catch (e) {
            g.iframeCallbackList[a.data.actionName] &&
              g.iframeCallbackList[a.data.actionName](a.data.data),
              window.iframeCallbackList[a.data.actionName] &&
                window.iframeCallbackList[a.data.actionName](a.data.data)
          }
      }
      Object.defineProperty(g, 'IFRAME_ENV', {
        set: function (a) {
          !0 === a && a !== this._iframeEnv
            ? ((this._iframeEnv = a), window.addEventListener('message', k))
            : !1 === a &&
              a !== this._iframeEnv &&
              ((this._iframeEnv = !1), window.removeEventListener('message', k))
        },
        get: function () {
          return this._iframeEnv || !1
        }
      }),
        Object.defineProperty(g, 'MAIA_SUPPORT', {
          set: function (a) {
        ...
        Object.defineProperty(g, 'MAIA_IFRAME_ID', {
          set: function (a) {
        ...
        Object.defineProperty(g, 'MAIA_SUPPORT_IFRAMES', {
          set: function (a) {
        ...
        g.IFRAME_ENV ||
          window.addEventListener('message', function (a) {
            if (null !== a.data && 'miniappEmit' === a.data.type) {
              ...
              window[a.data.callbackName] && window[a.data.callbackName](e)
            }
          }),
        (g.screenOrientation = s),
        (g.webviewDisplayMode = u),
        (g.navigationBarTitleMode = _),
        (g.videoSourceType = d),
        (g.install = function (a) {
          a.prototype.$maiaH5 = g
        }),
        (a.exports = g)
    },
    function (a, e, t) {
    ...
    function (a, e, t) {
      ...
      var o = t(3),
        ...
        Q = function (a, e) {
          v(a)
          for (var t, o = b((e = k(e))), n = 0, i = o.length; i > n; )
            Y(a, (t = o[n++]), e[t])
          return a
        },
        X = function (a) {
          ...
          return (
            !(this === V && n(B, a) && !n(U, a)) &&
            (!(e || !n(this, a) || !n(B, a) || (n(this, x) && this[x][a])) || e)
          )
        },
        $ = function (a, e) {
          if (((a = k(a)), (e = E(e, !0)), a !== V || !n(B, e) || n(U, e))) {
            var t = S(a, e)
            return (
              !t || !n(B, e) || (n(a, x) && a[x][e]) || (t.enumerable = !0), t
            )
          }
        },
        Z = function (a) {
          for (var e, t = R(k(a)), o = [], i = 0; t.length > i; )
            n(B, (e = t[i++])) || e == x || e == l || o.push(e)
          return o
        },
        aa = function (a) {
          for (
            var e, t = a === V, o = R(t ? U : k(a)), i = [], r = 0;
            o.length > r;

          )
            !n(B, (e = o[r++])) || (t && !n(V, e)) || i.push(B[e])
          return i
        }
      W ||
        (c(
          (P = function () {
            ...
            return i && H && K(V, a, { configurable: !0, set: e }), z(a)
          }).prototype,
          'toString',
          function () {
            return this._k
        ...
        (t(32).f = X),
        (C.f = aa),
        i && !t(20) && c(V, 'propertyIsEnumerable', X, !0),
        (p.f = function (a) {
          return z(f(a))
        })),
        r(r.G + r.W + r.F * !W, { Symbol: P })
      for (
        var ea =
      ...
      r(r.S + r.F * !W, 'Symbol', {
        for: function (a) {
          return n(j, (a += '')) ? j[a] : (j[a] = P(a))
        },
        keyFor: function (a) {
          if (!J(a)) throw TypeError(a + ' is not a symbol!')
          for (var e in j) if (j[e] === a) return e
        },
        useSetter: function () {
          H = !0
        },
      ...
      r(r.S + r.F * ia, 'Object', {
            ...
            'JSON',
            {
              stringify: function (a) {
                for (var e, t, o = [a], n = 1; arguments.length > n; )
                  o.push(arguments[n++])
                if (((t = e = o[1]), (w(e) || void 0 !== a) && !J(a)))
                  return (
                    h(e) ||
                      (e = function (a, e) {
                        if (
                          ('function' == typeof t && (e = t.call(this, a, e)),
                          !J(e))
                        )
                          return e
                      }),
        ...
        P.prototype[D] || t(14)(P.prototype, D, P.prototype.valueOf),
        _(P, 'Symbol'),
        _(Math, 'Math', !0),
        _(o.JSON, 'JSON', !0)
    },
    ...
    function (a, e, t) {
      ...
      a.exports =
        ...
        t(15)(function () {
          ...
          ? function (a, e) {
              for (
                var t = c(a), s = arguments.length, u = 1, _ = i.f, d = r.f;
                s > u;
    ...
    function (a, e, t) {
      ...
      a.exports = t(1).getIterator = function (a) {
        var e = n(a)
        if ('function' != typeof e) throw TypeError(a + ' is not iterable!')
        return o(e.call(a))
      }
    },
    function (a, e, t) {
    ...
    function (a, e) {
      !(function (e) {
        ...
        if (u) s && (a.exports = u)
          ...
          ;(u = e.regeneratorRuntime = s ? a.exports : {}).wrap = g
            ...
            (u.mark = function (a) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((a.__proto__ = N), l in a || (a[l] = 'GeneratorFunction')),
            ...
            (S.prototype = {
              ...
              finish: function (a) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                  ...
                  if (t.finallyLoc === a)
                    return this.complete(t.completion, t.afterLoc), O(t), m
                }
              },
              catch: function (a) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
        ...
        function C(a, e) {
          ...
          var n = k(o, a.iterator, e.arg)
          if ('throw' === n.type)
            return (e.method = 'throw'), (e.arg = n.arg), (e.delegate = null), m
          var i = n.arg
          return i
            ? i.done
          ...
          if (a) {
            ...
            if (!isNaN(a.length)) {
              var o = -1,
                i = function e() {
                  for (; ++o < a.length; )
                    if (n.call(a, o)) return (e.value = a[o]), (e.done = !1), e
    ...
    function (a, e, t) {
      t(62), t(19), t(31), t(113), t(121), t(122), (a.exports = t(1).Promise)
    },
    function (a, e, t) {
      'use strict'
      var o,
        ...
        x = function (a) {
          h.call(l, function () {
            ...
            T
              ...
              : (e = l.onrejectionhandled) && e({ promise: a, reason: a._v })
          })
        },
        D = function (a) {
          var e = this
      ...
      ;((e = a.exports =
        function (a, e, t, _, d) {
          var f,
            ...
            v = o(t, _, e ? 2 : 1),
            w = 0
          if ('function' != typeof h) throw TypeError(a + ' is not iterable!')
          if (i(h)) {
      ...
      ;(window.__make_phone_call_callback__ =
        ...
        (a.exports = {
                            ...
                            (e = w.call(this, {
                              ...
                              callbacks: {
                                __maia_get_app_info__: {
                                  method: function (a) {
                                    ;(window.data = v(a)), (window.appflag = !0)
                                  },
                                  appCallbackName: 'callback'
                                }
                              }
          ...
          getDeviceInfoOnlyIframe: function (a) {
            if (!p(a))
              throw new Error('在iframe模式下获取AppInfo必须给定回调函数做参数')
            this.IFRAME_ENV &&
              ((this.iframeCallbackList[I.GETDEVICEINFOIFRAME] = function (e) {
                a(e)
              }),
              window.top.postMessage(
                {
          ...
          getAppInfoOnlyIframe: function (a) {
            if (!p(a))
              throw new Error('在iframe模式下获取AppInfo必须给定回调函数做参数')
            this.IFRAME_ENV &&
              ((this.iframeCallbackList[I.GETAPPINFOIFRAME] = function (e) {
                a(e)
              }),
              window.top.postMessage(
                {
          ...
          getLocationByTencentMap: function (a) {
            if (((R = k(a)), this.IFRAME_ENV))
              (this.iframeCallbackList[I.GETTENCENTMAPLOCATION] = function (a) {
                R(a)
              }),
                window.top.postMessage(
                  {
          ...
          scanCode: function (a) {
            ...
            for (var C in (y > -1 && (r.autoCancel = y),
            e.scanningTip &&
          ...
          setStorage: function () {
            ...
            for (var i in ((e.callback = k(e.callback)),
            (t.key = e.key),
            h(e.data) || g(e.data)
            ...
            'APP' === a.type
              ...
              : ((j = e.callback),
                (r[y.SET_STORAGE] = { method: j, appCallbackName: 'callback' }))
            var c = n.join('&') + '&'
          ...
          getStorage: function (a, e, t) {
            ...
            f(t) && 'APP' === t
              ...
              : ((B = i),
                (c[y.GET_STORAGE] = { method: B, appCallbackName: 'callback' }))
            var l = n.join('&') + '&'
            ;(l += w.call(this, { apiName: 'getStorage', callbacks: c })),
              f(t) && 'APP' === t ? _('getStorageApp', l) : _('getStorage', l)
          },
          removeStorage: function (a, e, t) {
            ...
            var l = n.join('&') + '&'
            ;(l += w.call(this, { apiName: 'removeStorage', callbacks: c })),
              f(t) && 'APP' === t
          ...
          getStorageInfo: function (a, e) {
            ...
            var n = ''
            ;(n += w.call(this, { apiName: 'getStorageInfo', callbacks: o })),
              f(e) && 'APP' === e
          ...
          clearStorage: function (a) {
            ...
            p(a) || (e = m), (W = e)
            var t = {}
            t[y.CLEAR_STORAGE] = { method: W, appCallbackName: 'callback' }
            var o = ''
            ;(o += w.call(this, { apiName: 'clearStorage', callbacks: t })),
              _('clearStorage', o)
          },
        ...
        (a.exports = {
              ...
              if (d(e) || f(e))
                (t = new URL(_(a))),
                  (o = t.searchParams
                    ...
                    : p(t).callback),
                  this.IFRAME_ENV
                    ? ((this.iframeCallbackList[N.CREATEEXTENSION] = function (
                        a
                      ) {
                        window[o] && window[o](a)
                      }),
                ...
                this.IFRAME_ENV
                  ? ((t = new URL(r)),
                    (o = t.searchParams
                      ? t.searchParams.get('callback')
                      : p(t).callback),
                    (this.iframeCallbackList[N.CREATEEXTENSION] = function (a) {
                      window[o](a)
                    }),
                    window.top.postMessage(
                      {
          ...
          useNative: function (a, e, t) {
            ...
            for (var l in r)
              if ('callback' !== l)
                if (u(r[l]))
                  c += l + '=' + encodeURIComponent((0, n.default)(r[l])) + '&'
                else {
                  if (h(r[l]) || v(r[l])) continue
                  c += l + '=' + encodeURIComponent(r[l]) + '&'
                }
            if (((S = k(r.callback)), this.IFRAME_ENV))
              (this.iframeCallbackList[R.USENATIVE] = S),
                window.top.postMessage(
                  {
                    actionName: N.USENATIVE,
                    data: (0, n.default)({ protocol: o, path: i, params: r }),
                    el: this.MAIA_IFRAME_ID
                  },
                  '*'
                )
        ...
        (a.exports = {
          ...
          chooseVideo: function (a) {
            ...
            if (a.sourceType === O.ALBUM) {
              ...
              p(a.sizeLimit) && a.sizeLimit > 0 && (e.maxSize = a.sizeLimit)
            ...
            for (var m in e) t.push(m + '=' + e[m])
            if (((D = _(a.callback) ? a.callback : d), this.IFRAME_ENV))
          ...
          createCameraContext: function () {
            return (
              (P.IFRAME_ENV = this.IFRAME_ENV),
              (P.MAIA_IFRAME_ID = this.MAIA_IFRAME_ID),
              (P.iframeCallbackList = this.iframeCallbackList),
              P
            )
          },
          ...
          previewImage: function (a) {
            ...
            if (
              ...
              'string' == typeof r.downHide
                ? (e.downHide = g(r.downHide) || 0)
                : (e.downHide = r.downHide || 0),
              b(r.paths))
            )
              (e.paths = encodeURIComponent((0, o.default)([r.paths]))), (n = 1)
            else {
          ...
          (0, c.default)(a, [
            {
              ...
              value: function (a) {
                ...
                f(_) && (e.thumbWidth = _)
                var p = a.thumbHeight
                for (var m in (f(p) && (e.thumbHeight = p),
                (A = v(a.callback)),
                e))
                  t[n++] = m + '=' + e[m]
                this.IFRAME_ENV
                  ? ((this.iframeCallbackList[E.TAKEPHOTO] = function (a) {
                      A(a)
                    }),
                    window.top.postMessage(
                      {
                        actionName: E.TAKEPHOTO,
                        data: e,
                        el: this.MAIA_IFRAME_ID
                      },
                      '*'
            ...
            },
            {
              ...
              value: function (a) {
                ...
                t))
                  m(t[g])
                    ? r.push(g + '=' + encodeURIComponent((0, o.default)(t[g])))
                    : r.push(g + '=' + t[g])
                if (this.IFRAME_ENV)
                  (this.iframeCallbackList[E.TAKEPHOTOS] = function (a) {
                    N(a)
                  }),
                    window.top.postMessage(
                      {
                        actionName: E.TAKEPHOTOS,
                        data: (0, o.default)(e),
                        el: this.MAIA_IFRAME_ID
                      },
                      '*'
          ...
          (0, i.default)(a, [
            {
              ...
              value: function (a, e) {
                if (l(a))
                  if (((m = f(e)), this.IFRAME_ENV))
                    (this.iframeCallbackList[p.PLAY] = function (a) {
                      m(a)
                    }),
                      window.top.postMessage(
                        {
            ...
            },
            {
              ...
              value: function (a, e, t) {
                ...
                if (((b = f(t)), this.IFRAME_ENV))
                  (this.iframeCallbackList[p.COMPRESS] = function (a) {
                    b(a)
                  }),
                    window.top.postMessage(
                      {
                        actionName: p.COMPRESS,
    ...
    function (a, e, t) {
      ...
      function z(a) {
        ...
        try {
          for (
            ...
            ;(p.action = u.action),
              ('js' !== u.action && 1 * u.customized != 1) || (p.js = u.js),
              _(u.image) && '' !== m(u.image)
                ? ((p.image = m(u.image)),
                  _(u.bundle) && '' !== m(u.bundle) && (p.bundle = m(u.bundle)))
                : _(u.title) && '' !== m(u.title) && (p.title = m(u.title)),
      ...
      ;(window.__set_maia_page_orientation_callback__ =
        ...
        (window.__maia_set_navigation_bar_more_buttons_callback__ = function (
          a
        ) {
          H(v(a))
        }),
      ...
      var J = {
                ...
                if ('js' === a.action || 1 * a.customized == 1) {
                  ...
                  ;(t.IFRAME_ENV || p(a.js)) &&
                    ((c =
                      ...
                      n +
                      '_callback__' +
                      t.MAIA_IFRAME_ID.substr(1)),
                    (e[o][n].js = c)),
                    t.IFRAME_ENV && (t.iframeCallbackList[c] = r)
                  var l = {}
                  ;(l['__maia_set_navigation_' + o + '_' + n + '_callback__'] =
                    { method: r, appCallbackName: 'js' }),
                    g.call(t, { apiName: 'setNavigationBar', callbacks: l })
                }
              })
            }
          for (var i in a) o(i)
            ...
            if (r || c) {
              var s = (function (a) {
                ...
                for (var c in (null !== r && (e.right = r), e))
                  t[o++] = c + '=' + encodeURIComponent((0, n.default)(e[c]))
                return t.join('&')
              })(e)
        ...
        setNavigationBarTitle: function (a) {
          ...
          this.IFRAME_ENV
            ? window.top.postMessage(
                {
                  actionName: P.SETNAVIGATIONBARTITLE,
                  data: { mode: t, title: e, titleRightImage: o, bundle: i },
                  el: this.MAIA_IFRAME_ID
                },
                '*'
              )
            : ((n =
              ...
              (n += g.call(this, {
                ...
                callbacks: {
                  mawkClickTitle: { method: q, appCallbackName: 'callback' }
                }
              })),
        ...
        disableWebViewSwipe: function (a) {
          if (((j = k(a)), this.IFRAME_ENV))
            (this.iframeCallbackList[P.DISABLEWEBVIEWSWIPE] = j),
              window.top.postMessage(
                {
                  actionName: P.DISABLEWEBVIEWSWIPE,
                  data: {},
                  el: this.MAIA_IFRAME_ID
                },
                '*'
        ...
        setNavigationBarColor: function (a) {
          ...
          if (
            ((e.page = i),
            _(a.frontColor) && m(a.frontColor) && (e.textColor = a.frontColor),
            _(a.backgroundColor) &&
              m(a.backgroundColor) &&
        ...
        getWebviewDisplayMode: function (a) {
          if (((V = k(a)), this.IFRAME_ENV))
            return (
              (this.iframeCallbackList[P.GETWEBVIEWDISPLAYMODE] = function (a) {
                V(a)
              }),
              void window.top.postMessage(
                {
                  actionName: P.GETWEBVIEWDISPLAYMODE,
                  data: {},
                  el: this.MAIA_IFRAME_ID
                },
                '*'
        ...
        setWebviewDisplayModeSeparated: function (a) {
          return A('setWebviewDisplayModeSeparated')
            ? (window.navigator &&
                ...
                (/(iPhone|iPad|iPod|iOS)/i.exec(window.navigator.userAgent)
                  ? this.setWebviewDisplayMode(a.iosMode, a.whole, a.callback)
        ...
        setNavigationBarMoreButtons: function (a, e) {
          ...
          for (var t = [], i = a.length, r = 0; r < i; r++) {
            ...
            ;(window[s] = k(c.js)), (c.js = s), t.push(c)
          }
          H = k(e)
              ...
              [
                {
                  ...
                  value: function (a) {
                    if (((A = h(a)), this.IFRAME_ENV))
                      (window.iframeCallbackList[g.ADDCURRENTTAB] = function (
                        a
                      ) {
                        A(u(a))
                      }),
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    var i = this
                    if (
                      ((N = a.validateButtons(e)), (k = h(t)), this.IFRAME_ENV)
                    ) {
                      window.iframeCallbackList[g.SETBUTTONS] = function (a) {
                        k(u(a))
                      }
                      var r = []
                      ...
                      var c =
                        'custom=' + encodeURIComponent((0, o.default)(N)) + '&'
                      ;(c += b.call(this, {
                        apiName: 'setButtons',
                        callbacks: {
                ...
                },
                {
                  ...
                  value: function (a, e) {
                    return w('removeButton')
                      ? (N[a] && N.splice(a, 1), this.setButtons(N, e), null)
                      : ''
                  }
                },
                {
                  ...
                  value: function (a) {
                    ...
                    if (((E = h(a)), this.IFRAME_ENV))
                      (window.iframeCallbackList[g.SHOW] = function (a) {
                        E(u(a))
                      }),
                        window.top.postMessage(
                          {
                ...
                },
                {
                  key: 'clean',
                  value: function (a) {
                    return w('clean') ? (this.setButtons([], a), null) : null
                  }
                },
                {
                  key: 'CustomButtons',
                    ...
                    try {
                      ...
                      e.forEach(function (a) {
                        ...
                        if (a.bundle && !_(a.bundle))
                          throw new Error('按钮图片bundle参数类型必须为string')
                        if (a.js && !_(a.js))
                          throw new Error('按钮点击事件js参数必须为函数名')
                      })
                    } catch (a) {
                      e = []
                    }
      ...
      ;(window.__redirect_app_callback__ =
        ...
        (module.exports = {
          createPage: function (a) {
            if (!isUndefined(a) && !isNull(a)) {
              ...
              if (isString(a.title) && '' !== trim(a.title))
                ...
                throw new Error('当htmlTitle设置为0时，必须同时设置title值')
          ...
          closePage: function closePage(options) {
            ...
            isString(option.js) && '' !== trim(option.js)
              ...
              : (closeCurrentPage = isFunction(option.js)
                  ...
                  : emptyFun),
              this.IFRAME_ENV
                ? ((this.iframeCallbackList[ACTIONNAME.CLOSEPAGE] = function (
                    data
                  ) {
                    isFunction(closeCurrentPage)
                      ? closeCurrentPage(data)
                      : isString(closeCurrentPage) && eval(closeCurrentPage)
                  }),
                  window.top.postMessage(
                    {
          ...
          popWebViewStack: function (a, e) {
            ...
            ;(t = t || 1), (popWebviewStackCallback = formatCallbackByParam(e))
            var o = 'step=' + t + '&'
            ;(o += mountCallback.call(this, {
    ...
    function (a, e, t) {
      ...
      function O(a) {
        ...
        '0' === (e = v(e)).status
          ...
          : (this.upload_fail_callback({ status: e.status, error: e.message }),
            this.upload_complete_callback()),
          delete window[this.callbackFuncName]
      }
      function S(a) {
      ...
      ;(window.__maia_download_start_callback =
        ...
        (a.exports = {
          request: function (a, e) {
            ...
            if (((window[n.callbackFuncName] = T.bind(n)), this.IFRAME_ENV))
              (this.iframeCallbackList[A.REQUESTSUCCESS] = function (a) {
                ...
                (this.iframeCallbackList[A.REQUESTCOMPLETE] = function () {
                  t.complete()
                }),
                window.top.postMessage(
                  { actionName: A.REQUEST, data: o, el: this.MAIA_IFRAME_ID },
                  '*'
                )
            else {
              var c = {}
          ...
          uploadFile: function (a, e, t) {
            ...
            ;(r = { header: c.header, params: c.data, uploadFiles: o }),
              ...
              s(a) && '' !== f(a) && (r.url = f(a)),
              (c.success = k(c.success)),
              (c.fail = k(c.fail)),
              (c.complete = k(c.complete)),
              (c.progress = k(c.progress)),
              I++
            var d = {
            ...
            if (
              ...
              (this.iframeCallbackList[A.UPLOADFILESUCCESS] = function (a) {
                c.success(a)
              }),
                (this.iframeCallbackList[A.UPLOADFILEFAIL] = function (a) {
                  c.fail(a)
                }),
                (this.iframeCallbackList[A.UPLOADFILECOMPLETE] = function () {
                  c.complete()
                }),
                (this.iframeCallbackList[A.UPLOADFILECOMPLETE] = function (a) {
                  c.progress(a)
                }),
                window.top.postMessage(
                  {
              ...
              ;(h[d.callbackFuncName] = {
                ...
                (b += w.call(this, { apiName: 'uploadFile', callbacks: h })),
                l('upload', b)
            }
          },
          downloadFile: function (a, e, t) {
            var o = t ? g(t) : {}
            if (!s(a) || '' === f(a)) throw new Error('下载资源路径不能为空')
            var n = '',
              i = ''
            s(e) && '' !== f(e)
              ? ((i = f(e)), (n = 'savePath=' + encodeURIComponent(i) + '&'))
              : _(e) && (o = e),
              b(o.saveAlbum) &&
                o.saveAlbum &&
                (n += 'saveAlbum=' + Number(o.saveAlbum) + '&'),
              (o.success = k(o.success)),
              (o.onSaveAlbum = k(o.onSaveAlbum)),
              (o.fail = k(o.fail)),
              (o.complete = k(o.complete)),
              (o.progress = k(o.progress)),
              y++
            var r = {
            ...
            if (
              ...
              (window[r.saveAlbumcallbackFuncName] = P.bind(r)),
              this.IFRAME_ENV)
            )
              (this.iframeCallbackList[A.DOWNLOADFILESUCCESS] = function (a) {
                o.success(a)
              }),
                (this.iframeCallbackList[A.DOWNLOADFILEFAIL] = function (a) {
                  o.fail(a)
                }),
                (this.iframeCallbackList[A.DOWNLOADFILECOMPLETE] = function () {
                  o.complete()
                }),
                (this.iframeCallbackList[A.DOWNLOADFILEPROGRESS] = function (
                  a
                ) {
              ...
              ;(u[r.callbackFuncName] = {
                ...
                (c += w.call(this, { apiName: 'downloadFile', callbacks: u })),
                l('download', c)
            }
          },
          deleteFile: function (a, e, t) {
            ...
            if (this.IFRAME_ENV)
              ...
              ;(p[u.callbackFuncName] = {
                ...
                (_ += w.call(this, { apiName: 'deleteFile', callbacks: p })),
                l('deleteFile', _)
            }
          },
          download: function (a) {
          ...
          downloadQuery: function (a, e) {
            ...
            var t = [].concat((0, o.default)(a)),
              n = ''
            ;(n += 'requestIds=' + encodeURIComponent((0, i.default)(t)) + '&'),
              (x = k(e)),
              (n += w.call(this, {
          ...
          downloadDelete: function (a) {
            ...
            j = k(a.callback)
            var e =
              'requestId=' + a.requestId + '&delType=' + (a.delType || 0) + '&'
            ;(e += w.call(this, {
        ...
        (a.exports = {
          ...
          emitLoginIAMFinished: function (a, e) {
            ...
            c(
              ...
              'data=' + t + '&callback=__emit_login_iam_finished_callback__'
            )
          }
        })
    },
    function (a, e, t) {
      ...
      var E = {
        ...
        registerGroups: function (a, e, t) {
          ...
          s(o) && (o = [o]), (b = d(t))
          var i =
            'appKey=' + a + '&groups=' + encodeURIComponent(o.join(',')) + '&'
          ;(i += u.call(this, {
      ...
      a.exports = {
        ...
        deleteAliasAndGroups: function (a) {
          ...
          e && ((c(t) && 0 === t.length) || l(t) || (r(t) && !t))
            ...
            : c(t) || s(t)
            ? e
              ? (_(E.deleteAliasAndGroups, n), E.deleteAliasAndGroups(a, t, o))
      ...
      ;(window.__maia_get_facial_callback__ =
        ...
        (a.exports = {
          getFacial: function (a) {
            if (((s = c(a)), this.IFRAME_ENV))
              (this.iframeCallbackList[l.GETFACIAL] = function (a) {
                s(a)
              }),
                window.top.postMessage(
                  {
                    actionName: l.GETFACIAL,
                    data: {},
                    el: this.MAIA_IFRAME_ID
                  },
                  '*'
              ...
              var t = r.call(this, { apiName: 'getFacial', callbacks: e })
              n('getFacial', t)
            }
          }
        })
      ...
      ;(window[o.CHOOSE_INVOICE] =
        ...
        (a.exports = {
          chooseInvoice: function (a) {
            ...
            var n = t + '&',
              r = {}
            ;(r[o.CHOOSE_INVOICE] = { method: f, appCallbackName: 'callback' }),
              (r[o.SELECT_INVOICE] = {
                method: p,
                appCallbackName: 'selectCallback'
              }),
              (n += u.call(this, { apiName: 'chooseInvoice', callbacks: r })),
              i('chooseInvoice', n)
          }
        })
    },
    ...
    function (a, e, t) {
      ...
      var r = t(149),
        ...
        S = t(153).getFacial,
        M = t(154),
        R = M.setNavigationBarTitle,
        P = M.getWebviewDisplayMode,
        F = M.setNavigationBar,
        L = M.disableWebViewSwipe,
        x = M.addCurrentTab,
        D = M.setButtons,
        G = M.show,
        j = t(155),
        ...
        q = t(0),
        H = q.isArray,
        K = q.isNotEmptyObject,
        z = q.isNotEmptyString,
        J = q.paserObj
      function Y(a, e) {
          ...
          i = (function a() {
            for (
              ...
              if (K(s))
                ...
                z(s) && -1 !== s.indexOf('__maiaH5_custom_function__')
                  ? (function () {
        ...
        return (
          (W[a.data.actionName].MAIA_IFRAME_ID = a.data.el.substr(1)),
          (W[a.data.actionName].MAIA_SUPPORT_IFRAMES =
            window.__maia_glob_var.MAIA_SUPPORT_IFRAMES),
          W[a.data.actionName].apply(W, (0, n.default)(i)),
          null
        )
      }
      a.exports = {
          ...
          if (
            ...
            switch (e.data.actionName) {
              ...
              case V.DELETEFILE:
                u(e, t)
                break
              case V.GETDEVICEINFOIFRAME:
                f(e, t)
                break
              case V.GETAPPINFOIFRAME:
                d(e, t)
                break
              case V.GETLOCATION:
                p(e, t)
                break
              case V.GETTENCENTMAPLOCATION:
                b(e, t)
                break
              case V.GETNETWORK:
                m(e, t)
                break
              case V.CREATEEXTENSION:
                v(e, t)
                break
              case V.TAKEPHOTO:
                E(e, t)
              ...
              case V.GETRECORDER:
                N(e, t)
                break
              case V.GETRECORDERTEXT:
                I(e, t)
                break
              case V.GETFACIAL:
                S(e, t)
                break
              case V.SETNAVIGATIONBARTITLE:
                R(e, t)
                break
              case V.GETWEBVIEWDISPLAYMODE:
                P(e, t)
                break
              case V.GETTOKEN:
                w(e, t)
              ...
              case V.USENATIVE:
                g(e, t)
                break
              case V.SETNAVIGATIONBAR:
                F(e, t)
                break
              case V.DISABLEWEBVIEWSWIPE:
                L(e, t)
                break
              case V.CHOOSEVIDEO:
                T(e, t)
                  ...
                  for (;;)
                    switch ((a.prev = a.next)) {
                      ...
                      case 3:
                        ;(o = a.sent),
                          t.contentWindow.postMessage(
                            { actionName: _.GETDEVICEINFOIFRAME, data: o },
                            '*'
                          )
                      case 5:
                      case 'end':
        ...
        play: function (a, e) {
          ...
          i(o.createVideoContext().play, a),
            o.createVideoContext().play(t, function (a) {
              e.contentWindow.postMessage({ actionName: n.PLAY, data: a }, '*')
            })
        }
      }
    },
        ...
        setButtons: function (a, e) {
          ...
          t.forEach(function (a) {
            if (a.js) {
              var t = a.js
              window[t] = function (a) {
                e.contentWindow.postMessage({ actionName: t, data: a }, '*')
              }
            }
          }),
        ...
        show: function (a, e) {
          i(o.createFloatBallContext().show, a),
            o.createFloatBallContext().show(function (a) {
              e.contentWindow.postMessage({ actionName: n.SHOW, data: a }, '*')
            })
        }
      }
    },
