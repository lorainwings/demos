      ...
      return (
        ...
        (r.prototype.videoPlay = function () {
          return (
            (this.userPause = !1),
            this.waiting
              ? void (this.userPlay = !0)
              : ((this.userPlay = !1), void this.video.play())
          )
        }),
        ...
        (r.prototype.pause = function () {
          return (
            (this.userPlay = !1),
            this.waiting
              ? void (this.userPause = !0)
              : ((this.userPause = !1),
                this.video.pause(),
                void e.stopTick(this.markDirty, this))
          )
        }),
        ...
        (r.prototype.$updateRenderNode = function () {
          ...
          ;(this.isPlayed && !e.Capabilities.isMobile) || !i
            ? this.isPlayed &&
              ...
              (r.webGLTexture = null),
              t.drawImage(0, 0, r.width, r.height, 0, 0, n, a))
            : ((t.image = i),
              (t.imageWidth = n),
              (t.imageHeight = a),
      ...
      return (
            ...
            this.$textfield.height > this.$textfield.size
              ? ((this.inputDiv.style.top = i * a + 'px'),
                (this.inputElement.style.top =
                  (-this.$textfield.lineSpacing / 2) * a + 'px'))
              : ((this.inputDiv.style.top = i * a + 'px'),
                (this.inputElement.style.top = '0px'))
          for (var o = this.$textfield, s = 1, l = 1, c = 0; o.parent; )
            (s *= o.scaleX), (l *= o.scaleY), (c += o.rotation), (o = o.parent)
        ...
        (r.prototype.executeShow = function () {
          ;(this.inputElement.value = this.$getText()),
            ...
            null == this.inputElement.onfocus &&
        ...
        (r.prototype._onInput = function () {
          ...
          window.setTimeout(function () {
            t.inputElement &&
              t.inputElement.selectionStart == t.inputElement.selectionEnd &&
              ((t.textValue = t.inputElement.value),
              e.Event.dispatchEvent(t, 'updateText', !1))
          }, 0)
        }),
    ...
    var i = (function () {
      function t(t, i, n) {
        ;(this.surface = e.sys.createCanvasRenderBufferSurface(r, t, i, n)),
          ...
          this.context &&
            ((this.context.$offsetX = 0), (this.context.$offsetY = 0)),
          this.resize(t, i)
      }
      return (
      ...
      return (
        ...
        (r.prototype.getLocation = function (t) {
          ...
          return (
            90 == this.rotation
              ? ((s = l), (c = i.width - o))
              : -90 == this.rotation && ((s = i.height - l), (c = o)),
            (s /= this.scaleX),
            (c /= this.scaleY),
      ...
      if (((s || a) && (o = !1), o)) {
        ...
        ;(l.execWebFn = l.execWebFn || {}),
          (l.execWebFn.postX5GamePlayerMessage = function (t) {
            var r = t.type
            'app_enter_background' == r
              ? e.pause()
              : 'app_enter_foreground' == r && e.resume()
          }),
          (window.browser = l)
      }
    }
    ...
    var a = (function (r) {
      ...
      return (
        ...
        (i.$init = function () {
          ...
          if (a)
            try {
              t.WebAudioDecode.ctx = new (window.AudioContext ||
                window.webkitAudioContext ||
                window.mozAudioContext)()
            } catch (s) {
              a = !1
          ...
          var l,
            c = i._audioType
          ;(c == n.WEB_AUDIO && a) || c == n.HTML5_AUDIO
            ? ((l = !1), i.setAudioType(c))
            : !o && r.indexOf('safari') >= 0 && -1 === r.indexOf('chrome')
            ? ((l = !1), i.setAudioType(n.WEB_AUDIO))
            : ((l = !0), i.setAudioType(n.HTML5_AUDIO)),
            r.indexOf('android') >= 0
              ? l && a && i.setAudioType(n.WEB_AUDIO)
              : o &&
                i.getIOSVersion() >= 7 &&
                ((i._canUseBlob = !0), l && a && i.setAudioType(n.WEB_AUDIO))
          var h = window.URL || window.webkitURL
          h || (i._canUseBlob = !1),
            r.indexOf('egretnative') >= 0 &&
              (i.setAudioType(n.HTML5_AUDIO), (i._canUseBlob = !0)),
    ...
    function n(e, t, r, i) {
      if (e) {
        var n = e,
          a = n.surface
        i
          ? (a.width < t && (a.width = t), a.height < r && (a.height = r))
          : (a.width !== t && (a.width = t), a.height !== r && (a.height = r)),
          n.onResize()
      }
    }
    ...
    function s(t, r) {
      ...
      return a
        ? ((a[e.glContext] = n),
          ...
          (a[e.UNPACK_PREMULTIPLY_ALPHA_WEBGL] = !0),
    ...
    function l(t, r, i, n) {
      ...
      return s
        ? ((s[e.glContext] = o),
          ...
          (s[e.UNPACK_PREMULTIPLY_ALPHA_WEBGL] = !0),
          o.texImage2D(
            o.TEXTURE_2D,
            0,
            o.RGBA,
  ...
  !(function (t) {
    ...
    function i(r) {
      if (!s) {
        ...
        if (
          (i.indexOf('egretnative') >= 0 &&
            -1 == i.indexOf('egretwebview') &&
            (e.Capabilities.runtimeType = e.RuntimeType.RUNTIME2),
          ...
          egret_native.addModuleCallback(function () {
            ...
            var s
            ;(s = r.canvasScaleFactor
              ? r.canvasScaleFactor
              : r.calculateCanvasScaleFactor
              ? r.calculateCanvasScaleFactor(e.sys.canvasHitTestBuffer.context)
            ...
            for (
              var h = document.querySelectorAll('.egret-player'),
                u = h.length,
                d = 0;
              u > d;
              d++
          ...
          else if (r.calculateCanvasScaleFactor)
            u = r.calculateCanvasScaleFactor(e.sys.canvasHitTestBuffer.context)
          else {
          ...
          a(p),
            r.screenAdapter
              ...
              : e.sys.screenAdapter ||
                (e.sys.screenAdapter = new e.sys.DefaultScreenAdapter())
          for (
            var v = document.querySelectorAll('.egret-player'),
              g = v.length,
              x = 0;
            g > x;
            x++
    ...
    var r = (function (r) {
      ...
      return (
        ...
        (i.prototype.init = function (r, i) {
          ...
          ;(n.showFPS || n.showLog) &&
            (e.nativeRender ||
              c.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles)),
            (this.playerOption = n),
            (this.container = r),
            (this.canvas = s),
            (this.stage = a),
            ...
            (this.webInput = h),
            e.web.$cacheTextAdapter(h, a, r, s),
        ...
        (i.prototype.updateScreenSize = function () {
          ...
          if (!t.userTyping) {
            ...
            if (0 != a && 0 != o) {
              ...
              l != e.OrientationMode.AUTO &&
                (s =
                  (l != e.OrientationMode.PORTRAIT && o > a) ||
                  (l == e.OrientationMode.PORTRAIT && a > o))
              var c = s ? o : a,
                h = s ? a : o
              ;(e.Capabilities.boundingClientWidth = c),
                (e.Capabilities.boundingClientHeight = h)
              var u = e.sys.screenAdapter.calculateStageSize(
              ...
              var g = 0
              s
                ? l == e.OrientationMode.LANDSCAPE
                  ? ((g = 90),
                    (t.style.top = n + (o - p) / 2 + 'px'),
                    (t.style.left = (a + v) / 2 + 'px'))
                  : ((g = -90),
                    (t.style.top = n + (o + p) / 2 + 'px'),
                    (t.style.left = (a - v) / 2 + 'px'))
                : ((t.style.top = n + (o - v) / 2 + 'px'),
                  (t.style.left = (a - p) / 2 + 'px'))
              var x = p / d,
                y = v / f,
                m = x * e.sys.DisplayList.$canvasScaleFactor,
                b = y * e.sys.DisplayList.$canvasScaleFactor
              'canvas' == e.Capabilities.renderMode &&
                ((m = Math.ceil(m)), (b = Math.ceil(b)))
              ...
              e.Matrix.release(w),
                ...
                e.sys.DisplayList.$setCanvasScale(m, b),
                this.webTouchHandler.updateScaleMode(x, y, g),
                this.webInput.$updateSize(),
                this.player.updateStageSize(d, f),
                e.nativeRender && ((t.width = d * m), (t.height = f * b))
            }
          }
        }),
  ...
  !(function (t) {
    function r(t, r) {
      ...
      if (
        ...
        t.$renderBuffer
          ? (h = t)
          : ((h = new e.RenderTexture()), h.drawToTexture(new e.Bitmap(t)))
        for (
          var u = h.$renderBuffer.getPixels(r.x, r.y, a, o),
            d = new ImageData(a, o),
            f = 0;
          f < u.length;
          f++
      ...
      return (
        l.drawImage(
          p.$bitmapData.source,
          p.$bitmapX + r.x / e.$TextureScaleFactor,
          p.$bitmapY + r.y / e.$TextureScaleFactor,
          (x * r.width) / i,
          (y * r.height) / n,
          v,
          g,
    ...
    function o(t, i, n, a) {
      if (
        ...
        this.$renderBuffer
          ? (o = this)
          : ((o = new e.RenderTexture()), o.drawToTexture(new e.Bitmap(this)))
...
!(function (e) {
  ...
  !(function (t) {
    ...
    function i(e, t) {
      ...
      for (
        var r = new a(e.localName, t, e.prefix, e.namespaceURI, e.nodeName),
          n = e.attributes,
          s = r.attributes,
          l = n.length,
          c = 0;
...
!(function (e) {
  ...
  !(function (t) {
    var r = (function () {
      function e() {}
      return (
        (e.call = function (e, t) {}), (e.addCallback = function (e, t) {}), e
      )
    })()
  ...
  (function (e) {
    ...
    !(function (t) {
      ...
      ;(t.NativeExternalInterface = n),
        __reflect(n.prototype, 'egret.web.NativeExternalInterface', [
          'egret.ExternalInterface'
        ])
      var a = navigator.userAgent.toLowerCase()
      a.indexOf('egretnative') >= 0 &&
        ((e.ExternalInterface = n), (egret_native.receivedPluginInfo = r))
    })((t = e.web || (e.web = {})))
  })(egret || (egret = {})),
  (function (e) {
    var t
    !(function (t) {
      ...
      ;(t.WebViewExternalInterface = i),
        __reflect(i.prototype, 'egret.web.WebViewExternalInterface', [
          'egret.ExternalInterface'
        ])
...
!(function (e) {
  ...
  !(function (t) {
    var r = (function () {
      function t() {
        ...
        ;(this.vertices = new Float32Array(e)),
          (this._vertices = new ArrayBuffer(
            this.maxVertexCount * this.vertByteSize
          )),
      ...
      return (
        (t.prototype.reachMaxSize = function (e, t) {
          return (
            void 0 === e && (e = 4),
            void 0 === t && (t = 6),
            this.vertexIndex > this.maxVertexCount - e ||
              this.indexIndex > this.maxIndicesCount - t
          )
        }),
        ...
        (t.prototype.cacheArrays = function (
          t,
          r,
          i,
          n,
          ...
          var x = t.globalTintColor || 16777215,
            y = t.currentTexture
          g =
            1 > g && y && y[e.UNPACK_PREMULTIPLY_ALPHA_WEBGL]
              ? e.WebGLUtils.premultiplyTint(x, g)
              : x + ((255 * g) << 24)
          ...
          if (
            ((0 != S || 0 != R) &&
              ((_ = S * b + R * T + _), (C = S * w + R * E + C)),
            !f)
          ) {
            ;(0 != o || 0 != s) &&
              ((_ = o * b + s * T + _), (C = o * w + s * E + C))
            var L = l / n
            1 != L && ((b = L * b), (w = L * w))
            var D = c / a
            1 != D && ((T = D * T), (E = D * E))
          ...
          if (f) {
            ...
            if (this.hasMesh)
              for (var H = 0, F = p.length; F > H; ++H)
                this.indicesForMesh[this.indexIndex + H] =
                  p[H] + this.vertexIndex
            ...
            if (this.hasMesh) {
              ...
              ;(V[this.indexIndex + 0] = 0 + this.vertexIndex),
                (V[this.indexIndex + 1] = 1 + this.vertexIndex),
                (V[this.indexIndex + 2] = 2 + this.vertexIndex),
                (V[this.indexIndex + 3] = 0 + this.vertexIndex),
                (V[this.indexIndex + 4] = 2 + this.vertexIndex),
                (V[this.indexIndex + 5] = 3 + this.vertexIndex)
            }
    ...
    ;(t.WebGLVertexArrayObject = r),
      __reflect(r.prototype, 'egret.web.WebGLVertexArrayObject')
  })((t = e.web || (e.web = {})))
})(egret || (egret = {}))
var egret
!(function (e) {
      ...
      i = (function () {
        function i(r, i) {
          if (
            ...
            (this.$scissorState = !1),
            (this.vertSize = 5),
            (this.surface = e.sys.mainCanvas(r, i)),
            !e.nativeRender)
          ) {
        ...
        return (
          ...
          (i.prototype.initWebGL = function () {
            ...
            ;(this.$maxTextureSize = t.getParameter(t.MAX_TEXTURE_SIZE)),
              ...
              (this.etc1 =
                t.getExtension('WEBGL_compressed_texture_etc1') ||
                t.getExtension('WEBKIT_WEBGL_compressed_texture_etc1')),
              this.etc1 && (this.etc1.name = 'WEBGL_compressed_texture_etc1'),
              (e.Capabilities.supportedCompressedTexture =
                e.Capabilities.supportedCompressedTexture || {}),
              (e.Capabilities.supportedCompressedTexture.pvrtc = !!this.pvrtc),
              (e.Capabilities.supportedCompressedTexture.etc1 = !!this.etc1),
              (this._supportedCompressedTextureInfo =
                this._buildSupportedCompressedTextureInfo([
                  this.etc1,
                  this.pvrtc
                ]))
          }),
          ...
          (i.prototype.checkCompressedTextureInternalFormat = function (e, t) {
            for (var r = 0, i = e.length; i > r; ++r)
              for (
                var n = e[r], a = n.supportedFormats, o = 0, s = a.length;
                s > o;
                ++o
              )
                if (a[o][1] === t) return !0
          ...
          (i.prototype.$debugLogCompressedTextureNotSupported = function (
            t,
            i
          ) {
            if (!r[i]) {
          ...
          (i.prototype.createCompressedTexture = function (t, r, i, n, a) {
            var o = this.checkCompressedTextureInternalFormat(
              this._supportedCompressedTextureInfo,
              a
            )
            if (!o)
              return (
                this.$debugLogCompressedTextureNotSupported(
                  this._supportedCompressedTextureInfo,
                  a
                ),
            ...
            return l
              ? ((l[e.glContext] = s),
                (l[e.is_compressed_texture] = !0),
                s.bindTexture(s.TEXTURE_2D, l),
                s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1),
                (l[e.UNPACK_PREMULTIPLY_ALPHA_WEBGL] = !0),
                s.compressedTexImage2D(s.TEXTURE_2D, n, a, r, i, 0, t),
            ...
            get: function () {
              if (!this._defaultEmptyTexture) {
                ...
                ;(i.fillStyle = 'white'),
                  ...
                  (this._defaultEmptyTexture[e.engine_default_empty_texture] =
                    !0)
              }
            ...
            if (!t.webGLTexture) {
              if ('image' != t.format || t.hasCompressed2d()) {
                if (t.hasCompressed2d()) {
                  ...
                  t.webGLTexture = this.createCompressedTexture(
                    r.byteArray,
                    r.width,
                    r.height,
                    r.level,
              ...
              t.$deleteSource &&
                t.webGLTexture &&
                (t.source && ((t.source.src = ''), (t.source = null)),
                t.clearCompressedTextureData()),
          ...
          (i.prototype.drawImage = function (
            ...
            if (!this.contextLost && e && f) {
              ...
              p &&
                ...
                e.source &&
                  e.source.texture &&
                  ((f.$offsetX = v), (f.$offsetY = g), f.restoreTransform()))
            }
          }),
          (i.prototype.drawMesh = function (
            ...
            if (!this.contextLost && e && x) {
              ...
              y &&
                ...
                (e.texture || (e.source && e.source.texture)) &&
                  ((x.$offsetX = m), (x.$offsetY = b), x.restoreTransform()))
            }
          }),
          (i.prototype.drawTexture = function (
            ...
            if (!this.contextLost && e && x) {
              d && f
                ? this.vao.reachMaxSize(d.length / 2, f.length) &&
                  this.$drawWebGL()
                : this.vao.reachMaxSize() && this.$drawWebGL(),
                void 0 != g &&
                  e.smoothing != g &&
                  this.drawCmdManager.pushChangeSmoothing(e, g),
                u && this.vao.changeToMeshIndices()
              var y = f ? f.length / 3 : 2
              this.drawCmdManager.pushDrawTexture(e, y, this.$filter, c, h),
                (x.currentTexture = e),
          ...
          (i.prototype.drawRect = function (e, t, r, i) {
            ...
            !this.contextLost &&
              ...
              (n.currentTexture = null),
              this.vao.cacheArrays(n, 0, 0, r, i, e, t, r, i, r, i))
          }),
            ...
            if (r) {
              ...
              switch (r.type) {
                case 0:
                  o
                    ? 'custom' === o.type
                      ? (n = t.EgretWebGLProgram.getProgram(
                          a,
                          o.$vertexSrc,
                          o.$fragmentSrc,
                          o.$shaderKey
                        ))
                      : 'colorTransform' === o.type
                      ? r.texture[e.etc_alpha_mask]
                        ...
                        : (n = t.EgretWebGLProgram.getProgram(
                            a,
                            t.EgretShaderLib.default_vert,
                            t.EgretShaderLib.colorTransform_frag,
                            'colorTransform'
                          ))
                      : 'blurX' === o.type
                      ? (n = t.EgretWebGLProgram.getProgram(
                    ...
                    ? ((n = t.EgretWebGLProgram.getProgram(
                        a,
                        t.EgretShaderLib.default_vert,
                        t.EgretShaderLib.texture_etc_alphamask_frag,
                        e.etc_alpha_mask
                      )),
                      a.activeTexture(a.TEXTURE1),
                      a.bindTexture(a.TEXTURE_2D, r.texture[e.etc_alpha_mask]))
                    : (n = t.EgretWebGLProgram.getProgram(
                        a,
                        t.EgretShaderLib.default_vert,
                        t.EgretShaderLib.texture_frag,
                        'texture'
                      )),
                ...
                case 1:
                  ;(n = t.EgretWebGLProgram.getProgram(
                    a,
                    t.EgretShaderLib.default_vert,
                    t.EgretShaderLib.primitive_frag,
                    'primitive'
                  )),
                    this.activeProgram(a, n),
                    this.syncUniforms(n, o, r.textureWidth, r.textureHeight),
                ...
                case 8:
                  ...
                  l &&
                    (l.rootRenderTarget && l.rootRenderTarget.enabledStencil(),
                    l.enableScissor(r.x, r.y, r.width, r.height))
                  break
                case 9:
              ...
              for (var i in r)
                'aVertexPosition' === i
                  ? (e.vertexAttribPointer(
                    ...
                    e.enableVertexAttribArray(r.aVertexPosition.location))
                  : 'aTextureCoord' === i
                  ? (e.vertexAttribPointer(
                      r.aTextureCoord.location,
                      2,
                      e.FLOAT,
                      !1,
                      20,
                    ...
                    e.enableVertexAttribArray(r.aTextureCoord.location))
                  : 'aColor' === i &&
                    (e.vertexAttribPointer(
                      r.aColor.location,
                      4,
          ...
          (i.prototype.drawTargetWidthFilters = function (e, r) {
            ...
            if (a > 1)
              for (var o = 0; a - 1 > o; o++) {
                ...
                ;(i = t.WebGLRenderBuffer.create(l, c)),
            ...
            var h = e[a - 1]
            this.drawToRenderTarget(h, r, this.currentBuffer),
              r != n && t.WebGLRenderBuffer.release(r)
          }),
            ...
            if (!this.contextLost) {
              ...
              if ('blur' == e.type) {
                var l = e.blurXFilter,
                  c = e.blurYFilter
                0 != l.blurX && 0 != c.blurY
                  ? ((n = t.WebGLRenderBuffer.create(o, s)),
              ...
              i.saveTransform(),
                ...
                (i.currentTexture = r.rootRenderTarget.texture),
                this.vao.cacheArrays(i, 0, 0, o, s, 0, 0, o, s, o, s),
                i.restoreTransform(),
                this.drawCmdManager.pushDrawTexture(
                  r.rootRenderTarget.texture,
                  2,
                  e,
                  o,
                  s
  ...
  !(function (t) {
    var r = (function (r) {
      function n(i, n, a) {
        ...
        if (
          ((o.currentTexture = null),
          (o.globalAlpha = 1),
          (o.globalTintColor = 16777215),
          (o.stencilState = !1),
          (o.$stencilList = []),
          ...
          return (
            a
              ...
              : (o.surface = new egret_native.NativeRenderSurface(o, i, n, a)),
            (o.rootRenderTarget = null),
            o
          )
        if (
          ((o.rootRenderTarget = new t.WebGLRenderTarget(
            o.context.context,
            3,
            3
          )),
      ...
      return (
        ...
        (n.prototype.resize = function (t, r, i) {
          return (
            ...
            (r = r || 1),
            e.nativeRender
              ? void this.surface.resize(t, r)
              : (this.context.pushBuffer(this),
                (t != this.rootRenderTarget.width ||
                  r != this.rootRenderTarget.height) &&
                  (this.context.drawCmdManager.pushResize(this, t, r),
                  (this.rootRenderTarget.width = t),
                  (this.rootRenderTarget.height = r)),
                this.root && this.context.resize(t, r, i),
                this.context.clear(),
  ...
  !(function (t) {
    var r = ['source-over', 'lighter', 'destination-out'],
      ...
      a = (function () {
        ...
        return (
          (a.prototype.render = function (t, r, i, a) {
            this.nestLevel++
            var o = r,
              s = o.context
            s.pushBuffer(o),
            ...
            if (
              (i.$invertInto(c),
              o.transform(c.a, c.b, c.c, c.d, 0, 0),
              e.Matrix.release(c),
              this.nestLevel--,
              0 === this.nestLevel)
            ) {
          ...
          (a.prototype.drawDisplayObject = function (t, r, i, n, a) {
            ...
            if (
              (l && !a
                ? ((t.$cacheDirty ||
                    t.$renderDirty ||
                    l.$canvasScaleX != e.sys.DisplayList.$canvasScaleX ||
                    l.$canvasScaleY != e.sys.DisplayList.$canvasScaleY) &&
                    (s += l.drawToSurface()),
                  (o = l.$renderNode))
                : (o = t.$renderDirty ? t.$getRenderNode() : t.$renderNode),
              (t.$cacheDirty = !1),
              o)
            ) {
            ...
            if (c) {
              ...
              for (var h = c.length, u = 0; h > u; u++) {
                var d = c[u],
                  ...
                  g = void 0
                1 != d.$alpha &&
                  ((v = r.globalAlpha), (r.globalAlpha *= d.$alpha)),
                  16777215 !== d.tint &&
                    ((g = r.globalTintColor), (r.globalTintColor = d.$tintRGB))
                var x = void 0
                if (d.$useTranslate) {
                  var y = d.$getMatrix()
                  ;(f = i + d.$x), (p = n + d.$y)
                  ...
                  ;(x = e.Matrix.create()),
                    ...
                    (x.tx = m.tx),
                    (x.ty = m.ty),
                    r.transform(y.a, y.b, y.c, y.d, f, p),
                    (f = -d.$anchorOffsetX),
                    (p = -d.$anchorOffsetY)
                } else
                  (f = i + d.$x - d.$anchorOffsetX),
                ...
                if (
                  (v && (r.globalAlpha = v), g && (r.globalTintColor = g), x)
                ) {
          ...
          (a.prototype.drawWithFilter = function (t, a, o, s) {
            ...
            if (
              t.$children &&
              0 == t.$children.length &&
              (!t.$renderNode || 0 == t.$renderNode.$getRenderCount())
            )
              return l
            var c,
              h = t.$filters,
            ...
            if (
              !t.mask &&
              1 == h.length &&
              ('colorTransform' == h[0].type ||
                ('custom' === h[0].type && 0 === h[0].padding))
            ) {
              ...
              if (!t.$children || 1 == x)
                return (
                  ...
                  (l += t.$mask
                    ? this.drawWithClip(t, a, o, s)
                    : t.$scrollRect || t.$maskRect
                    ? this.drawWithScrollRect(t, a, o, s)
                    : this.drawDisplayObject(t, a, o, s)),
            ...
            if (
              ...
              (l += t.$mask
                ? this.drawWithClip(t, y, -f, -p)
                : t.$scrollRect || t.$maskRect
                ? this.drawWithScrollRect(t, y, -f, -p)
                : this.drawDisplayObject(t, y, -f, -p)),
              y.context.popBuffer(),
              l > 0)
            ) {
              u && a.context.setGlobalCompositeOperation(c),
          ...
          (a.prototype.drawWithClip = function (t, a, o, s) {
            ...
            if (d || (t.$children && 0 != t.$children.length)) {
              ...
              if (
                (m.context.pushBuffer(m),
                (c += this.drawDisplayObject(t, m, -v, -g)),
                d)
              ) {
                ...
                w.copyFrom(d.$getConcatenatedMatrix()),
                  ...
                  b.context.popBuffer(),
                  m.context.setGlobalCompositeOperation('destination-in'),
                  m.setTransform(1, 0, 0, -1, 0, b.height)
                var T = b.rootRenderTarget.width,
                  E = b.rootRenderTarget.height
                m.context.drawTexture(
                  b.rootRenderTarget.texture,
                  0,
                  0,
                  T,
                  E,
                  ...
                  m.context.setGlobalCompositeOperation('source-over'),
                  b.setTransform(1, 0, 0, 1, 0, 0),
                  n.push(b)
              }
              if (
                (m.context.setGlobalCompositeOperation(i),
                m.context.popBuffer(),
                c > 0)
              ) {
                c++,
                ...
                ;(_.a = C.a),
                  ...
                  (_.tx = C.tx),
                  (_.ty = C.ty),
                  C.append(1, 0, 0, -1, o + v, s + g + m.height)
                var S = m.rootRenderTarget.width,
                  R = m.rootRenderTarget.height
                a.context.drawTexture(
                  m.rootRenderTarget.texture,
                  0,
                  0,
                  S,
                  R,
          ...
          (a.prototype.drawWithScrollRect = function (e, t, r, i) {
            ...
            var o = t.globalMatrix,
              s = t.context,
              l = !1
            if (t.$hasScissor || 0 != o.b || 0 != o.c)
              t.context.pushMask(a.x + r, a.y + i, a.width, a.height)
            else {
              var c = o.a,
                h = o.d,
                u = o.tx,
            ...
            return (
              (n += this.drawDisplayObject(e, t, r, i)),
          ...
          (a.prototype.renderBitmap = function (t, n) {
            ...
            if (a) {
              ...
              var g
              if (
                (p == p && ((g = n.globalAlpha), (n.globalAlpha *= p)),
                t.filter)
              ) {
                for (n.context.$filter = t.filter; h > u; )
                  n.context.drawImage(
                    a,
                    c[u++],
                    c[u++],
              ...
              if (
                (f && n.context.setGlobalCompositeOperation(i),
                p == p && (n.globalAlpha = g),
                d)
              ) {
          ...
          (a.prototype.renderMesh = function (t, n) {
            ...
            var g
            if (
              (p == p && ((g = n.globalAlpha), (n.globalAlpha *= p)), t.filter)
            ) {
              for (n.context.$filter = t.filter; h > u; )
                n.context.drawMesh(
                  l,
          ...
          (a.prototype.___renderText____ = function (r, i) {
            ...
            if (!(0 >= n || 0 >= a) && n && a && 0 !== r.drawData.length) {
              ...
              var c = r.x * o,
                h = r.y * s
              ;(r.$canvasScaleX !== o || r.$canvasScaleY !== s) &&
                ((r.$canvasScaleX = o),
                (r.$canvasScaleY = s),
                (r.dirtyRender = !0)),
                (c || h) && i.transform(1, 0, 0, 1, c / o, h / s),
                r.dirtyRender &&
                  t.TextAtlasRender.analysisTextNodeAndFlushDrawLabel(r)
              ...
              if (u && u.length > 0) {
                for (
                  ...
                  ;(p = u[b]),
                    ...
                    (x = p.textBlocks),
                    (i.$offsetX = d + v)
                  for (var T = 0, E = x.length; E > T; ++T)
                    (y = x[T]),
                      T > 0 && (i.$offsetX -= y.canvasWidthOffset),
                      (i.$offsetY =
                        f +
                        g -
                        (y.measureHeight +
                          (y.stroke2 ? y.canvasHeightOffset : 0)) /
                          2),
                      (m = y.line.page),
                      ...
                      (i.$offsetX += y.contentWidth - y.canvasWidthOffset)
                }
          ...
          (a.prototype.renderText = function (r, i) {
            if (t.textAtlasRenderEnable)
              return void this.___renderText____(r, i)
            var n = r.width - r.x,
              a = r.height - r.y
            if (!(0 >= n || 0 >= a) && n && a && 0 != r.drawData.length) {
              var o = e.sys.DisplayList.$canvasScaleX,
              ...
              if (
                ...
                this.wxiOS10
                  ? (this.canvasRenderer ||
                    ...
                    r.dirtyRender &&
                      (this.canvasRenderBuffer = new t.CanvasRenderBuffer(
                        n,
                        a
                      )))
                  : this.canvasRenderBuffer && this.canvasRenderBuffer.context
                  ? r.dirtyRender && this.canvasRenderBuffer.resize(n, a)
                  : ((this.canvasRenderer = new e.CanvasRenderer()),
                ...
                if (
                  ((1 != o || 1 != s) &&
                    this.canvasRenderBuffer.context.setTransform(
                      o,
                      0,
                      0,
                      s,
                  ...
                  if (
                    ...
                    (u.isCanvas = !0), (r.$texture = u)
                  else {
                    var d = r.$texture
                    d
                      ? i.context.updateTexture(d, u)
                      : ((d = i.context.createTexture(u)), (r.$texture = d))
                  }
          ...
          (a.prototype.renderGraphics = function (r, i, n) {
            ...
            if (!(0 >= a || 0 >= o) && a && o && 0 != r.drawData.length) {
              ...
              ;(1 > a * s || 1 > o * l) && (s = l = 1),
                (r.$canvasScaleX != s || r.$canvasScaleY != l) &&
                  ((r.$canvasScaleX = s),
                  (r.$canvasScaleY = l),
                  (r.dirtyRender = !0)),
                (a *= s),
              ...
              if (
                ...
                this.wxiOS10
                  ...
                  : this.canvasRenderBuffer && this.canvasRenderBuffer.context
                  ? r.dirtyRender && this.canvasRenderBuffer.resize(a, o)
                  : ((this.canvasRenderer = new e.CanvasRenderer()),
                ...
                if (n) {
                  ...
                  this.wxiOS10
                    ? ((u.isCanvas = !0), (d = u))
                    : (e.WebGLUtils.deleteWebGLTexture(u),
                      (d = i.context.getWebGLTexture(u))),
                    i.context.drawTexture(
                      d,
                      0,
                      0,
    ...
    ;(t.WebGLRenderer = a),
      __reflect(a.prototype, 'egret.web.WebGLRenderer', [
    ...
    var r = (function (e) {
      ...
      return (
        ...
        (t.prototype.updateUV = function () {
          var e = this.line
          return e
            ? ((this.u = e.x + this.x + 1 * this.border),
              (this.v = e.y + this.y + 1 * this.border),
              !0)
            : !1
        }),
    ...
    var i = (function (e) {
      ...
      return (
        ...
        (t.prototype.isCapacityOf = function (e) {
          ...
          return (
            i && ((t = i.x + i.width), (r = i.y)),
            t + e.width > this.maxWidth
              ? !1
              : this.dynamicMaxHeight > 0 &&
                (e.height > this.dynamicMaxHeight ||
                  e.height / this.dynamicMaxHeight < 0.5)
              ? !1
              : !0
          )
        }),
    ...
    var n = (function (e) {
      ...
      return (
        ...
        (t.prototype.addLine = function (e) {
          ...
          return e.maxWidth > this.pageWidth
            ? (console.error(
                'line.maxWidth = ' +
                  e.maxWidth +
                  ', this.pageWidth = ' +
              ...
              !1)
            : r + e.dynamicMaxHeight > this.pageHeight
            ? !1
            : ((e.x = t), (e.y = r), (e.page = this), this.lines.push(e), !0)
        }),
        t
      )
    })(e.HashObject)
    ...
    var a = (function (e) {
      ...
      return (
        ...
        (t.prototype.addTextBlock = function (e) {
          ...
          e.updateUV()
          for (
            var r = !1, i = t, n = this._sortLines, a = 0, o = n;
            a < o.length;
            a++
          ) {
            var s = o[a]
        ...
        (t.prototype._addTextBlock = function (e) {
          ...
          if (!o.addTextBlock(e, !0))
            return (
              console.error(
                '_addTextBlock !newLine.addTextBlock(textBlock, true)'
              ),
              null
            )
          ...
          return h.addLine(o)
            ? [h, o]
            : (console.error('_addText newPage.addLine failed'), null)
        }),
        ...
        return (
          ...
          (t.back = function (e, r) {
            if (e) {
              var i = t.pool
              if (r && i.indexOf(e) >= 0)
                return void console.error('DrawLabel.back repeat')
              e.clear(), i.push(e)
            }
          }),
          (t.pool = []),
      ...
      return (
        ...
        (r.prototype.reset = function (t, r) {
          return (
            ...
            (this.charWithStyleHashCode = e.NumberUtils.convertStringToHashCode(
              this.hashCodeString
            )),
        ...
        (r.prototype.measureAndDraw = function (t) {
          ...
          if (r) {
            ...
            var d = 3,
              f = Math.pow(10, d)
            ;(this.canvasWidthOffset =
              Math.floor(this.canvasWidthOffset * f) / f),
              (this.canvasHeightOffset =
                Math.floor(this.canvasHeightOffset * f) / f)
            ...
            p.save(),
              ...
              s &&
                ((p.lineWidth = 2 * s),
                p.strokeText(i, r.width / 2, r.height / 2)),
        ...
        (r.prototype.measure = function (t, i, n) {
          ...
          if (a && r.chineseCharacterMeasureFastMap[i.font])
            return r.chineseCharacterMeasureFastMap[i.font]
          var o = e.sys.measureText(
            t,
            i.fontFamily,
            n || i.size,
            i.bold,
      ...
      return (
        ...
        (s.analysisTextNodeAndFlushDrawLabel = function (a) {
          if (a) {
            ...
            for (
              var l = a[t.property_drawLabel], c = 0, h = l;
              c < h.length;
              c++
            ) {
              var u = h[c]
            ...
            for (
              ...
              ;(p = f[m + 0]),
                ...
                (x = f[m + 3] || {}),
                (y.length = 0),
                t.__textAtlasRender__.convertLabelStringToTextAtlas(
                  g,
                  new n(a, x),
                  y
                )
        ...
        (s.prototype.convertLabelStringToTextAtlas = function (t, i, n) {
          for (
            ...
            var h = c[l]
            if ((o.reset(h, i), s[o.charWithStyleHashCode]))
              n.push(s[o.charWithStyleHashCode])
            else {
              o.measureAndDraw(a)
              var u = this.book.createTextBlock(
                h,
                a.width,
                a.height,
                o.measureWidth,
              ...
              if (u) {
                ...
                var d = u.page
                d.webGLTexture ||
                  (d.webGLTexture = this.createTextTextureAtlas(
                    d.pageWidth,
                    d.pageHeight,
                    r
                  ))
        ...
        Object.defineProperty(s.prototype, 'canvas', {
          get: function () {
            return (
              this._canvas || (this._canvas = e.sys.createCanvas(24, 24)),
              this._canvas
            )
          },
          enumerable: !0,
...
!(function (e) {
  ...
  !(function (e) {
    var t = (function () {
      ...
      return (
        (e.prototype.initCount = function (e) {
          var t = this.type
          switch (t) {
            case 5126:
            case 5120:
...
!(function (e) {
  ...
  !(function (e) {
    ...
    function i(t, r) {
      for (
        var i = {}, n = t.getProgramParameter(r, t.ACTIVE_ATTRIBUTES), a = 0;
        n > a;
        a++
      ) {
    ...
    function n(t, r) {
      for (
        var i = {}, n = t.getProgramParameter(r, t.ACTIVE_UNIFORMS), a = 0;
        n > a;
        a++
      ) {
    ...
    var a = (function () {
      ...
      return (
        (e.getProgram = function (t, r, i, n) {
          return (
            this.programCache[n] || (this.programCache[n] = new e(t, r, i)),
            this.programCache[n]
          )
        }),
  ...
  !(function (e) {
    var t = (function () {
      ...
      return (
        ...
        (e.colorTransform_frag_etc_alphamask_frag =
